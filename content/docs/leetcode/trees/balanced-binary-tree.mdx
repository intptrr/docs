...
In the naive approach, we calculate the height of each subtree and check if the difference in heights is greater than 1. If it is, the tree is not balanced.
...
## Approach 2: Depth-First Search (Bottom-Up)
